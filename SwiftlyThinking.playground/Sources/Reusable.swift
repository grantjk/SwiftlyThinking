...
public extension UITableView {
    func register<Cell: Reusable>(cellType: Cell.Type) where Cell: UITableViewCell {
       register(cellType.self, forCellReuseIdentifier: cellType.identifier())
    }

    func dequeue<Cell: Reusable>(indexPath: IndexPath) -> Cell where Cell: UITableViewCell {
...
public extension UICollectionView {
    func register<Cell: Reusable>(cellType: Cell.Type) where Cell: UICollectionViewCell {
        register(cellType.self, forCellWithReuseIdentifier: cellType.identifier())
    }
    func dequeue<Cell: Reusable>(indexPath: IndexPath) -> Cell where Cell: UICollectionViewCell {
